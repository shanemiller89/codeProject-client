    ...
    <Grid container component="main" className={classes.root}>
      ...
      <Grid item xs={false} sm={4} md={7} className={classes.background}>
        <div className={classes.title}>
          <img alt="logo" src="https://firebasestorage.googleapis.com/v0/b/codeproject-client.appspot.com/o/app_resources%2Fbig_CP_logo.png?alt=media&token=c369ec04-95c4-4a84-946e-9b0b07466ca2" />
        </div>
      </Grid>
          ...
          <form className={classes.form} onSubmit={submitLogin}>
            ...
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <Lock className={classes.formIcon} />
                  </InputAdornment>
                )
              }}
            />
